...
SELECT listings.property_type, COUNT(*), MAX(reviews.date_reviewed) FROM reviews INNER JOIN listings ON reviews.listing_id = listings.id GROUP BY listings.property_type;
